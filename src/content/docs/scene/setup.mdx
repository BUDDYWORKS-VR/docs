...
<Tabs>  
  <TabItem label="VCC - New Scene">
  	<Steps>
			...
			![The scene data can be generated via the toolbar menu.](./img/001.webp)  
 	...
 	<TabItem label="VCC - Upgrade existing Scene">
 		<Steps>
 			...
 			![The current scene can be upgraded to Avatar Scene using the toolbar menu.](./img/004.webp)
