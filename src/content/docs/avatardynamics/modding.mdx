...
Do not store custom data inside the AD Folder, since the data gets replaced after every update or reinstallation of the PE Package. **Store any custom data in /Assets/.**  
...
![Avatar Dynamics audio import recommendation.](./img/002.png)  
