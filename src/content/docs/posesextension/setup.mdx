...
<table>
	<tr>
		<td>![Sync tab in settings window, allowing you to change the sync state of each PE component.](./img/009.webp)</td>
		<td>![Other tab in settings window, allowing modification of various PE modifiers.](./img/010.webp)</td>
	</tr>
</table>
Poses Extension comes with an settings window you can access through the Toolbar menu. *(BUDDYWORKS -> Poses Extension -> Settings...)*  
  
**Sync:** Change what syncs to other players. Features will still work locally.  
**Other:** Adjust certain modifiers to your needs.
