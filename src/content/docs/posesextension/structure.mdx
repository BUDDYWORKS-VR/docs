...
| **PE/Settings/DisableProxy**                   | Bool                     | *Unsynced* parameter which disables dial proxy-toggle handling.                                 |
...
| **PE/HeadAdjust/Active**                       | Bool                     | *Synced or Unsynced* parameter that states whenever HeadAdjust is active or not.               |
| **PE/HeadAdjust/X, Y & Z**                     | Float                    | *Synced or Unsynced* parameter defining head position on each axis.                           |
...
| **Go/Float**           | Float  | Similar to PE/Float, used for any radial selections by GGL.                                   |
...
| **PE/Favorite/HeadAdjust/WasActive_A**         | Bool            | Stored value for PE/Favorite/HeadAdjust/WasActive_A, A being the respective save slot.       |
| **PE/Favorite/HeadAdjust/X_A**                 | Float           | Stored value for PE/HeadAdjust/X, A being the respective save slot.                           |
| **PE/Favorite/HeadAdjust/Y_A**                 | Float           | Stored value for PE/HeadAdjust/Y, A being the respective save slot.                           |
| **PE/Favorite/HeadAdjust/Z_A**                 | Float           | Stored value for PE/HeadAdjust/Z, A being the respective save slot.                           |
| **PE/HeadAdjust/Reset**                        | Trigger         | Will reset HeadAdjust to its default values.                                                  |
| **PE/Proxy/ViewAdjust**                        | Bool            | Triggers PE/ViewAdjust/Active on when its dials are used.                                    |
| **PE/Proxy/HandAdjust**                        | Bool            | Triggers PE/HandAdjust/Active on when its dials are used.                                    |
| **PE/Proxy/HeadAdjust**                        | Bool            | Triggers PE/HeadAdjust/Active on when its dials are used.                                    |
