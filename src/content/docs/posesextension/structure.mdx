...
- **PE/Proxy/ViewAdjust [Bool]:** Triggers PE/ViewAdjust/Active on when it's dials are used.
- **PE/Proxy/HandAdjust [Bool]:** Triggers PE/HandAdjust/Active on when it's dials are used.
- **PE/Proxy/HeadAdjust [Bool]:** Triggers PE/HeadAdjust/Active on when it's dials are used.
